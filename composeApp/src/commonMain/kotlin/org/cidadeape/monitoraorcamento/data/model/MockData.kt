...
val mockListEmpenhos = listOf(
    ...
    Empenho(
        ...
        "2025",
        "1169",
        "Reforma e Acessibilidade de Passeios Públicos",
        "4",
        "Despesas de Capital",
        "4",
        "Investimentos",
...
val mockListDespesas = listOf(
    Despesa(
        ...
        valPagoRestos = 0.0,
        valSuplementado = 0.0,
        valPagoExercicio = 1050000.0,
        valCanceladoReserva = 0.0,
        valDescongelado = 0.0,
        valReservado = 2000.0,
        valEmpenhadoLiquido = 10034000.0,
        valTotalEmpenhado = 12034000.0,
        valReservadoLiquido = 2000.0,
        valAnuladoEmpenho = 2000000.0,
